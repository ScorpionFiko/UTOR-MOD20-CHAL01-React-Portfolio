                                ...
                                <section className="overlay d-flex justify-content-center align-items-center">
                                    <ul className="nav flex-row justify-content-center align-items-center">
                                        <li className="nav-item m-2">
                                            <a className="nav-link" href={project.href} target="_blank" rel="noopener noreferrer"><TbWorldWww size={70} /></a>
                                        </li>
                                        <li className="nav-item m-2">
                                            <a className="nav-link" href={project.github} target="_blank" rel="noopener noreferrer"><FaGithub size={70} /></a>
                                        </li>
                                    </ul>
                                </section>
                            </section>)
